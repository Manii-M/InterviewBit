...
*/
// bool DFS(vector<vector<int>> &adjlist,int v,int count,vector<int> visited)
// {

//     if(visited[v]!=-1 && visited[v]!=count)
//         return false;
//     visited[v] = count;
//     bool answer = true;
...
//       if(visited[adj[i]]==-1)
//       {
//           answer &= DFS(adjlist,adj[i],1-count,visited);
//       }
//       else
//       {
//           if(visited[adj[i]]==visited[adj[i]])
//                 return false;
//       }
//       if(!answer)
//             return false;
