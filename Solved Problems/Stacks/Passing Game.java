...
Explanation 2:
 ...
 Ball is passed to 2.
 /*
 *Approach - use stack and whenever ball is passed back just pop the top element and return top element who will possed the ball
 TC - O(n) 
*/
public
class Solution
{
public
    int solve(int A, int B, ArrayList<Integer> C)
    {
