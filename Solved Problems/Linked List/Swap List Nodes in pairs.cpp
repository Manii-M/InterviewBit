/**
 * Question - Swap List Nodes in pairs
Problem Description
 ...
 *
 /* Approach - we can just swap the values and answer is there.
  *or if asked to swap the nodes only just swap nodes and it's easy to do it
  * 
*/
/**
